...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("kanban", "Multi-profile collaboration board (tasks, links, comments)",
               "Tools & Skills", args_hint="[subcommand]",
               subcommands=("init", "boards", "create", "list", "ls", "sla", "show", "assign",
                            ...
                            "heartbeat", "assignees", "context", "specify", "brief", "gc")),
    CommandDef("brief", "Generate the board brief on-demand (wraps morning_brief.py)",
               "Tools & Skills", args_hint="[--window 4h] [--date 2026-06-02] [--dry-run]",
               aliases=("morning-brief",)),
